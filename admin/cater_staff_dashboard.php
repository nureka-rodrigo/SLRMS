...
$count1 = CaterStaff::getOrderCount();
$count2 = CaterStaff::getFoodCount();
?>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-secondary fw-bold text-xs mb-1"><span>Total Food</span></div>
                                            <div class="text-dark fw-bold h5 mb-0">
                                                <span>
                                                    <?php
                                                    echo $count2;
                                        ...
                                        <div class="col-auto"><i class="fas fa-hamburger fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>

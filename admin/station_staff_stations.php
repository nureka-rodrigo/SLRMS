...
if (isset($_GET['page'])) {
    if ($_GET['page'] < 1) {
        header('Location: station_staff_stations.php?page=1');
        exit;
    } else if ($_GET['page'] > $number_of_page) {
        header('Location: station_staff_stations.php?page=' . $number_of_page);
        exit;
    }
}
...
if(isset($_GET['status'])){
    if($_GET['status'] == 1){
        ...
        echo '<script>alert("Station creation successfull!");</script>';
    } else if($_GET['status'] == 3){
        echo '<script>alert("An error occured!");</script>';
    } else if($_GET['status'] == 4){
        echo '<script>alert("Station deleted successfully!");</script>';
    ...
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark bg-dark accordion p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0">
                <a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0"
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Station Staff</span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="modal fade" id="addNewStation" tabindex="-1" aria-labelledby="addNewStationLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title h3" id="addNewStationLabel">Add Station</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div id="modal-body" class="modal-body bg-dark text-light">
                                    <div class="form-outline form-white h5">
                                        <label class="form-label h5" for="station_name">Station Name</label>
                                        <br />
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Station Details</h3>
                    <!-- Button trigger modal -->
                    <button class="btn btn-primary btn-md" type="submit" data-bs-toggle="modal"
                        data-bs-target="#addNewStation" style="float: right;">Add New Station</button>
                    <br></br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn btn-danger"
                                                                href="../includes/station_staff.inc.php?action=delete&target=station&id=<?php echo $row['Station_Id']; ?>" name="delete">Delete </a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
                                        ...
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link" aria-label="Previous"
                                                    href="station_staff_stations.php?page=<?php echo $page - 1; ?>">
                                                ...
                                                if ($i == $page) {
                                                    ...
                                                    <li class="page-item">
                                                        <a class="page-link active"
                                                            href="station_staff_stations.php?page=<?php echo $i; ?>">
                                                            <?php echo $i; ?> </a>
                                                    </li>
                                                    <?php
                                                } else {

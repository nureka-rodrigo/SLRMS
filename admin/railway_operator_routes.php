...
if (isset($_GET['page'])) {
    if ($_GET['page'] < 1) {
        header('Location: railway_operator_routes.php?page=1');
        exit;
    } else if ($_GET['page'] > $number_of_page) {
        header('Location: railway_operator_routes.php?page=' . $number_of_page);
        exit;
    }
}
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark bg-dark accordion p-0"
            ...
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="railway_operator_trains.php">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <form action="../includes/railway_operator.inc.php" method="POST">
                    <div class="modal fade" id="addNewRoute" tabindex="-1" aria-labelledby="addNewRouteLabel"
                        aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title h3" id="addNewRouteLabel">Add Route</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                                <div id="modal-body" class="modal-body bg-dark text-light">
                                    <div class="form-outline form-white h5">
                                        <label class="form-label h5" for="route_name">Route Name</label>
                                        <br />
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-dark text-light"
                                        ...
                                        <button type="submit" class="btn btn-primary" name="addRoute">Add</button>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Route Details</h3>
                    <!-- Button trigger modal -->
                    <button class="btn btn-primary btn-md" type="submit" data-bs-toggle="modal"
                        data-bs-target="#addNewRoute" style="float: right;">Add New Route</button>
                    <br></br>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn btn-danger"
                                                                href="../includes/railway_operator.inc.php?action=delete&target=route&id=<?php echo $row['Route_Id']; ?>"
                                        ...
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link" aria-label="Previous"
                                                    href="railway_operator_routes.php?page=<?php echo $page - 1; ?>">
                                                ...
                                                if ($i == $page) {
                                                    ...
                                                    <li class="page-item">
                                                        <a class="page-link active"
                                                            href="railway_operator_routes.php?page=<?php echo $i; ?>">
                                                            <?php echo $i; ?> </a>
                                                    </li>
                                                    <?php
                                                } else {

...
<body id="page-top">
    ...
    if (isset($_GET['page'])) {
        if ($_GET['page'] < 1) {
            header('Location: admin_reviews.php?page=1');
        } else if ($_GET['page'] > $number_of_page) {
            header('Location: admin_reviews.php?page=' . $number_of_page);
        }
    }
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark bg-dark accordion p-0" style="padding-bottom: 0px;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="#"><i class="fas fa-comment"></i><span>Reviews</span></a></li>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <nav class="d-lg-flex justify-content-lg-end dataTables_paginate paging_simple_numbers">
                                        <ul class="pagination">
                                            <li class="page-item">
                                                <a class="page-link" aria-label="Previous" href="admin_reviews.php?page=<?php echo $page - 1; ?>">
                                            ...
                                            ?>
                                                    <li class="page-item">
                                                        <a class="page-link active" href="admin_reviews.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                                    </li>
                                                <?php
                                                } else {
                                                ?>
                                                    <li class="page-item">
                                                        <a class="page-link" href="admin_reviews.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                                                    </li>
                                            <?php
                                                }
                                            }
                                            ?>
                                            <li class="page-item">
                                                <a class="page-link" aria-label="Next" href="admin_reviews.php?page=<?php echo $page + 1; ?>">
                                                    <span aria-hidden="true">»</span>
                                                </a>
                                            </li>
                                        </ul>

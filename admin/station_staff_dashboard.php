...
$count1 = StationStaff::getReservationCount();
$count2 = StationStaff::getStationCount();
$count3 = StationStaff::getNoticeCount();
?>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark bg-dark accordion p-0" style="padding-bottom: 0px;">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="station_staff_reservations.php"><i class="far fa-registered"></i><span>Reservations</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="station_staff_stations.php"><i class="far fa-building"></i><span>Stations</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="station_staff_notices.php"><i class="far fa-bell"></i><span>Notices</span></a></li>
                </ul>
                            ...
                            <div class="card shadow border-start-success py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>Total Reservations</span></div>
                                        ...
                                        <div class="col-auto"><i class="far fa-registered fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-secondary fw-bold text-xs mb-1"><span>Total Stations</span></div>
                                            <div class="text-dark fw-bold h5 mb-0">
                                                <span>
                                                    <?php
                                                    echo $count2;
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>Total Notices</span></div>
                                            <div class="text-dark fw-bold h5 mb-0">
                                                <span>
                                                    <?php
                                                    echo $count3;

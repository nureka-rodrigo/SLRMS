...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a id="anchor5" class="nav-link active" data-bss-hover-animate="pulse"
    ...
    <section class="py-4 py-xl-5 pt-lg-0">
        <div class="container">
            <div class="row">
                <div class="col">
                    <iframe allowfullscreen="" frameborder="0" loading="lazy"
                        src="https://www.google.com/maps/embed/v1/place?key=AIzaSyB384I8vMbYuEKaFpLZWIlQvNaGZE-PrFk&amp;q=WVJ6%2BJ3Q%2C+Olcott+Mawatha%2C+Colombo+01000&amp;zoom=12"
                    ...
                    <div class="d-flex flex-column justify-content-center align-items-start h-100">
                        ...
                        <div class="d-flex align-items-center p-3">
                            <div
                                class="bs-icon-md bs-icon-rounded bs-icon-primary d-flex flex-shrink-0 justify-content-center align-items-center d-inline-block bs-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-linkedin">
                                    <path
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">https://www.linkedin.com/company/sri-lanka-railways</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            <div
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">https://twitter.com/RailwayLanka</p>
                            </div>
                        </div>
                        <div class="d-flex align-items-center p-3">
                            <div
                            ...
                            <div class="px-2">
                                ...
                                <p class="mb-0">WVJ6+J3Q, Olcott Mawatha, Colombo 01000</p>
                            </div>
                        </div>
                    </div>
                </div>
